...
} (jQuery));;(function( SiteListing, $, undefined ) {
...
})(window.Standish.SiteListing = window.Standish.SiteListing || {}, jQuery);;(function( Homepage, $, undefined ) {
...
})(jQuery);;// Load the dom in order to make sure parent hubspot script is loaded first
